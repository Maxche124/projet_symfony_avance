...
- (Optionnel mais conseillé pour gagner du temps de build. Nécessite Composer installé sur la machine ainsi que PHP v8.4) Faites un `composer install` à la racine du projet
